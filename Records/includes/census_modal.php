...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-m">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="census_edit.php" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-12">
                    <label for="population" class="form-label">Population</label>
                    <input type="text" class="form-control" id="edit_population" name="population" required>
                  </div>
                </div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="census_delete.php">
                <input type="hidden" class="id" name="id">
                <div class="text-center">
                    <p>DELETE CENSUS</p>
                    <h2 class="bold year"></h2> 
                </div>
            </div>
            <div class="modal-footer">
